...
def run_migration():
    ...
    tables_to_migrate = {
        ...
        'leads': [
            ...
            ('serp_page', 'INTEGER', 'INTEGER'),
            ('serp_position', 'INTEGER', 'INTEGER'),
            ('source_query', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('discovery_timestamp', 'TIMESTAMP', 'DATETIME'),
        ],
        'email_drafts': [
            ('user_id', 'VARCHAR(255)', 'VARCHAR(255)'),
        ...
        'scraping_jobs': [
            ...
            ('total_queries_processed', 'INTEGER DEFAULT 0', 'INTEGER DEFAULT 0'),
            ('unique_domains_found', 'INTEGER DEFAULT 0', 'INTEGER DEFAULT 0'),
            ('websites_crawled', 'INTEGER DEFAULT 0', 'INTEGER DEFAULT 0'),
            ('emails_found', 'INTEGER DEFAULT 0', 'INTEGER DEFAULT 0'),
            ('valid_emails', 'INTEGER DEFAULT 0', 'INTEGER DEFAULT 0'),
            ('rejected_leads', 'INTEGER DEFAULT 0', 'INTEGER DEFAULT 0'),
        ...
        'analysis_reports': [
            ...
            ('sales_intelligence_json', 'JSONB', 'JSON'),
        ],
        'pain_points': [
        ...
        'dork_opportunities': [
            ...
            ('trend_score', 'INTEGER DEFAULT 0', 'INTEGER DEFAULT 0'),
            ('confidence_score', 'INTEGER DEFAULT 0', 'INTEGER DEFAULT 0'),
        ...
        'dork_source_data': [
            ...
            ('source_type', 'VARCHAR(100)', 'VARCHAR(100)'),
            ('title', 'TEXT', 'TEXT'),
            ('url', 'TEXT', 'TEXT'),
            ('raw_text', 'TEXT', 'TEXT'),
            ('country', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('region', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('keyword', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('published_at', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('fetched_at', 'TIMESTAMP', 'DATETIME'),
            ('source_hash', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('status', "VARCHAR(50) DEFAULT 'fresh'", "VARCHAR(50) DEFAULT 'fresh'"),
        ],
        'dork_trend_analysis': [
            ('analysis_date', 'VARCHAR(100)', 'VARCHAR(100)'),
            ('trend_name', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('country', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('region', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('sector', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('domain', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('business_requirements', 'TEXT', 'TEXT'),
            ('why_this_region', 'TEXT', 'TEXT'),
            ('why_this_sector', 'TEXT', 'TEXT'),
            ('recommended_service', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('confidence_score', 'INTEGER DEFAULT 0', 'INTEGER DEFAULT 0'),
        ...
        'dork_recommendations': [
            ('recommendation_date', 'VARCHAR(100)', 'VARCHAR(100)'),
            ('trend_id', 'INTEGER', 'INTEGER'),
            ('trend_name', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('country', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('region', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('sector', 'VARCHAR(255)', 'VARCHAR(255)'),
            ...
            ('dorks', 'TEXT', 'TEXT'),
            ('urls', 'TEXT', 'TEXT'),
            ('why_this_dork', 'TEXT', 'TEXT'),
            ('opportunity_score', 'INTEGER DEFAULT 0', 'INTEGER DEFAULT 0'),
            ('status', "VARCHAR(50) DEFAULT 'ready'", "VARCHAR(50) DEFAULT 'ready'"),
            ('fingerprint', 'VARCHAR(255)', 'VARCHAR(255)'),
            ('created_at', 'TIMESTAMP', 'DATETIME'),
        ],
        'dork_pipeline_state': [
            ('value', 'TEXT', 'TEXT'),
